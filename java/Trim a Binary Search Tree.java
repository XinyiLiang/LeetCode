...
class Solution {
    ...
    public TreeNode trimBST(TreeNode root, int low, int high) {
        ...
        ans = FindTheRoot(root,low,high);
        
       if ( ans == null)
           return ans;
        
       if( ans.left != null)
           ans.left = trimBST(ans.left, low, high);
         if( ans.right != null)
           ans.right = trimBST(ans.right, low, high);
        
       return ans;
    }
    
    
     public TreeNode FindTheRoot(TreeNode root, int low, int high) {
         ...
         if(root != null)
         {
             ...
             return FindTheRoot(root.right, low, high);
            else if ( root.val > high)
             return FindTheRoot(root.left, low, high);
         }
         return null;
     }
