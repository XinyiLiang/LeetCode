 ...
 * subtree root, its original right subtree should be the right subtree of the new right subtree root. 
 * If depth d is 1 that means there is no depth d-1 at all, then create a tree node with value v as the
    ...
    public TreeNode addOneRow(TreeNode root, int v, int d) {
        ...
        while( d>= depth+1 )
        {
            ...
            else
            {
                ...
                depth = hasNextDepth? depth+1 : depth;
            }
